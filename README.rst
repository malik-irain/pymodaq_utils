This repository has been **ARCHIVED** as we moved it into a MonoRepository together with PyMoDAQ and its side project: PyMoDAQ GUI and Data, please go to PyMoDAQ__ main repo to    continue working on its development!
